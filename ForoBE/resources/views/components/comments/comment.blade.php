<div class="card mb-2">
    <div class="card-body">
        ...
        @include('partials.tags', ['element' => $comment])
        @include('partials.images', ['element' => $comment])
        <p class="card-text text-end">
            ...
            <small class="text-muted mx-1">{{ $comment->author }} wrote on {{ $comment->created_at->toLocaleString() }}</small>
        </p>
    </div>
</div>
